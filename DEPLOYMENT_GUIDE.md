...
You're ready to ship! Here's the step-by-step checklist to get **Digital Solari** live at `splitflap.cc`.
...
2. Add a custom domain: `splitflap.cc`
...
### Test the Live App
1. Open `https://splitflap.cc` in browser
2. You should see the homepage
3. Click "Connect Board" → you get a board at `https://splitflap.cc/board`
4. Phone: scan QR code or visit `https://splitflap.cc/controller?code=XXXXXX`
...
## 🛡️ Optional: Add SSL/TLS (Already Done by Railway)

Railway auto-provisions SSL for both:
- `https://digital-solari-prod-xxxxx.railway.app`
- `https://splitflap.cc` (after you add custom domain)
...
- The code auto-detects; make sure you're on `https://splitflap.cc` not `http://`
...
6. (Optional) Add custom domain `splitflap.cc`

### Result
**Your app is live at `splitflap.cc` with:**
